...
<div class="container">
  <div class="text-content">
    ...
    <p>
      ...
      At the SOEP, my research focuses on well-being. As a behavioral economist, my work primarily explores health 
      economics, well-being, and the development of risk preferences. I also have a keen interest in the economics of 
      entrepreneurship. My research has been featured in esteemed journals such as 
      <em>Entrepreneurship, Theory and Practice (IF = 10.5)</em>, 
      <em>Journal of Population Economics (IF = 6.5)</em>, and 
      <em>PLOS ONE (IF = 3.7)</em>. In 2022, I was honored with an award for one of the best publications at DIW Berlin. 
